    ...
    public function fororderitemsDatatable($id = false) {
        ...
        if ($request->request->get("length")) {
            ...
            foreach (@(array) $results as $result) {
                ...
                $json[11] = '<input data-id="' . $obj->getId() . '" data-rep="SoftoneBundle:Product" data-ref="' . $obj->getId() . '" id="SoftoneBundleProductQty_' . $obj->getId() . '" class="SoftoneBundleProductQty" type="text" value="1"><div><div class="gui-icon"><i class="fa fa-database"></i><span class="title"><a target="_blank" href="#"></a></span></div></div>';
