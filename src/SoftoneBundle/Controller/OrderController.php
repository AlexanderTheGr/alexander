    ...
    function getfmodeltypes($brand) {
        ...
        foreach ($brands as $brand) {
            ...
            $out .= "<li style='width:120px; height: 120px; float: left; list-style: none'>"
                    . "<div style='float:left; width:100%' class='modeldiv'><img class='modelitem' style='border: 1px; z-index:100; position:absolute; display: none; left:0;' style='max-width:820px; max-height: 820px;' src='" . $urlpath . "Photos/EFAR" . "/" . $brand["model_id"] . ".jpg'>"
                    . "<center><img style='max-width:120px; max-height: 120px;' src='" . $urlpath . "Photos/EFAR" . "/" . $brand["model_id"] . ".jpg'></div>"
