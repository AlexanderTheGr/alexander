...
class ProductController extends \SoftoneBundle\Controller\SoftoneController {
    ...
    function retrieveMtrl($MTRL = 0) {
        ...
        if (count($params) > 0) {
            ...
            if ($this->getSetting("SoftoneBundle:Softone:apothiki") == 'tzianetas' OR $this->getSetting("SoftoneBundle:Softone:apothiki") == 'iaponikh' OR $this->getSetting("SoftoneBundle:Softone:merchant") == 'gianop') {
