...
class ProductController extends \SoftoneBundle\Controller\SoftoneController {
    ...
    public function gettabs($id) {
        ...
        $fields["itemCccpriceupd"] = array("label" => "Συχρονισμός", 'type' => "select", 'dataarray' => $dataarray, "required" => false, "className" => "col-md-3 col-sm-3");
        $fields["itemCccwebupd"] = array("label" => "WEB", 'type' => "select", 'dataarray' => $dataarray, "required" => false, "className" => "col-md-3 col-sm-3");       
