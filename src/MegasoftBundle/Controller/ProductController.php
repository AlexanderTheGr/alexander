...
class ProductController extends Main {
    ...
    public function gettabs($id) {
        ...
        $fields["replaced"] = array("label" => "Replaced by", "disabled" => $entity->replaced == '' ? false : true, "className" => "col-md-6", "required" => false);
    ...
    function retrieveProduct($params = array()) {
        ...
        file_put_contents("downliad20.xml", $server_output);

        //$StoreDetails = \simplexml_load_string($server_output);
        $result = \simplexml_load_file("downliad20.xml");
