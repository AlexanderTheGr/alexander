        ...
        if ($request->request->get("length")) {
            ...
            if ($this->clearstring($dt_search["value"]) != "") {
                ...
                if ($search[0] == 'productfreesearch') {
                    ...
                    $sqlearch = "Select o.id from MegasoftBundle:ProductSearch o where o.lreplacer = p.erpCode OR p.erpCode like '%" . $search[1] . "%' OR o.erpCode like '%" . $search[1] . "%' OR o.supplierCode like '%" . $search[1] . "%'";
                }
