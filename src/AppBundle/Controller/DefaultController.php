...
class DefaultController extends Main {
    ...
    public function alerts() {
        ...
        foreach ($orders as $order) {
            $ordersHtml .= "<li class='' style='list-style:none'><a href='".$this->getSetting("AppBundle:Erp:erpprefix")."/order/view/" . $order->getId() . "'>" . $order->getFincode() . " " . $order->getCustomerName() . "</a></li>";
        }
        $ordersHtml .= "</ul>";
