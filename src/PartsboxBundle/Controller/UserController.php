...
class UserController extends Main {
    ...
    var $repository = 'PartsboxBundle:User';
    ...
    public function indexAction() {
        ...
        return $this->render('PartsboxBundle:User:index.html.twig', array(
                    'pagename' => 'Customers',
    ...
    public function viewAction($id) {
        $datatables = array();
        return $this->render('PartsboxBundle:User:view.html.twig', array(
                    'pagename' => 'Product',
                    'url' => '/user/save',
                    'ctrl' => $this->generateRandomString(),
                    'app' => $this->generateRandomString(),
