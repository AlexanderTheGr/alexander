...
class Orderitem {
    ...
    /**
     * @var \PartsboxBundle\Entity\Product
     */
    private $product;
     ...
     * Set product
     *
     * @param \PartsboxBundle\Entity\Product $product
     *
     * @return Orderitem
     */
    public function setProduct(\PartsboxBundle\Entity\Product $product = null) {
     ...
     * Get product
     *
     * @return \PartsboxBundle\Entity\Product
     */
