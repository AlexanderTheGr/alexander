...
class Customergrouprule
{
    ...
    /**
     * @var \PartsboxBundle\Entity\Customergroup
     *
     * @ORM\ManyToOne(targetEntity="PartsboxBundle\Entity\Customergroup")
     * @ORM\JoinColumns({
     ...
     * Set group
     *
     * @param \PartsboxBundle\Entity\Customergroup $group
     *
     * @return Customergrouprule
     */
    public function setGroup(\PartsboxBundle\Entity\Customergroup $group = null)
    {
        $this->group = $group;
     ...
     * Get group
     *
     * @return \PartsboxBundle\Entity\Customergroup
     */
